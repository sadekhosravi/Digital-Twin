...
export default function Twin() {
    ...
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        ...
        <div className="twin-panel" aria-label="Digital twin chat preview">
          ...
          <div className="conversation" ref={conversationRef}>
            ...
            {messages.length === 0 && (
              <div className="suggestions"><button type="button" onClick={() => setInput('What are you working on?')}>What are you working on?</button><button type="button" onClick={() => setInput('Tell me about Steward')}>Tell me about Steward</button></div>
            )}
          </div>
      ...
      <footer className="footer" id="contact"><div><p className="eyebrow">Let&apos;s think together</p><h2>Have a good question?</h2><p className="footer-copy">I&apos;m always open to thoughtful conversations, interesting problems, and new ways of looking at things.</p></div><div className="footer-links"><a href="mailto:sadegh.khosravi@gmail.com">Email me <ArrowUpRight size={15} /></a><a href="https://www.linkedin.com/in/sade-khosravi" target="_blank" rel="noreferrer"><Link2 size={15} /> LinkedIn</a><a href="https://github.com/sadekhosravi" target="_blank" rel="noreferrer"><Link2 size={15} /> GitHub</a></div><div className="footer-bottom"><span>© 2026 Sadegh Khosravi</span><span>Made with curiosity.</span></div></footer>
    </main>
